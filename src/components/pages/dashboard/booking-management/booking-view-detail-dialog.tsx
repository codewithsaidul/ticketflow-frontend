...
const BookingViewDetailDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      {/* Changes made:
        1. Removed 'min-w-4xl' (which forced it to be huge).
        2. Added 'w-[95vw]' (takes 95% of screen width on mobile).
        3. Added 'sm:max-w-4xl' (limits size only on larger screens).
        4. Added 'max-h-[85vh]' to ensure it fits vertically with browser bars.
      */}
      <DialogContent className="w-[95vw] sm:max-w-4xl max-h-[85vh] flex flex-col p-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 sm:px-6 sm:pb-6">
          ...
          {/* Adjusted padding (p-4) and gap for mobile */}
